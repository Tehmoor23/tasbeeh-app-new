...
const styles = StyleSheet.create({
  ...
  privacyModalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: Platform.select({ ios: 2, default: 10 }), paddingBottom: Platform.select({ ios: 8, default: 10 }) },
  privacyModalTitle: { fontSize: 24, fontWeight: '700', letterSpacing: 0.2 },
  privacyModalCloseBtn: { paddingVertical: Platform.select({ ios: 8, default: 6 }), paddingHorizontal: 8, marginLeft: 12 },
